...
서버 27개 테스트, 기존 38개 기능·7개 게임·14개 아지트 기능 회귀 검사, 여섯 모험의 실제 브라우저 완주와 공동 원정, 320px의 25문양 터치 훈련, 필수 프로필 팝업, 일곱 화면 폭 검사를 통과했습니다. 운영용 읽기 전용 화면 점검 코드도 합성 Worker에서 검증했습니다. 실제 기기 또는 운영 모험의 합성 쓰기를 수행했다는 뜻은 아닙니다.
